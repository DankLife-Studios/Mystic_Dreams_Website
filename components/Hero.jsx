            ...
            <div className="relative z-10 px-4 py-8 sm:px-6 sm:py-10 lg:py-12" style={{ background: "var(--gradient-hero)" }}>
                ...
                <div className="hero-grid">
                    <div>
                        ...
                        <div className="hero-actions animate-fade-up animate-delay-3 mt-6 flex flex-wrap gap-3">
                            <Link href="/connect" className="btn-primary shadow-lg shadow-purple-500/20 hover:shadow-purple-500/30 transition-shadow">
                    ...
                    <div>
                        <div className="relative">
                            ...
                            <Image
                                ...
                                width={150}
                                height={150}
                                className="relative rounded-2xl shadow-2xl shadow-purple-500/20 ring-1 ring-white/10"
                                priority
                            />
                        </div>
                    </div>
