export const SITE = {
  ...
  description:
    "Mystic Dreams RP — Welcome Home. Discord whitelist, 48 player slots, and 30+ custom systems built for serious roleplay. Law and EMS, whitelisted businesses, a deep civilian economy, phone and tablet apps, entertainment, and a full criminal underworld — all in one living city.",
  about:
...
export const CONNECT_STEPS = [
  ...
  },
  {
    ...
    icon: "key",
    link: { href: "/whitelist", label: "Whitelist Guide" },
  },
  {
    number: 4,
    title: "Find the Server",
    description: `Search for "${SITE.name}" in the FiveM server list, or use your cfx.re join link.`,
    icon: "city",
  },
];
